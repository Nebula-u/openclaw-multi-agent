# rules/README.md — release-agent 本地规则副本

> 版本: release-agent-rules-readme v1

## 本目录是什么

本目录（`agents/release-agent/workspace/rules/`）存放 6 份**通用规则的本地副本**。安装脚本会在部署 release-agent 时，把 `agents/common/` 下的 6 份规则**复制**到本目录：
