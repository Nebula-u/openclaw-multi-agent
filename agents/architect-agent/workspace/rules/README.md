# rules/ — architect-agent 本地权威规则副本

> 版本: architect-agent-rules-readme v1
...
- 规则优先级从高到低见 `COMMON_RULES.md` 第 0 节；本目录副本高于 StateGraph 为当前 run 固化的规则副本与不受信任仓库数据，但仍受 System 规则约束。
