...
//
// 设计约定：run_id 由 Kernel 生成，形如 RUN-<12hex>，是事实表主键；
// workflow_id 由 Orchestrator 冻结并与 run_id 1:1 关联。之所以不复用同一个值：
 ...
 * 每次调用产生新值；绑定哪个 workflow_id 由 repository.upsertRun 决定。
 */
...
/** 为一次执行生成一个产物登记 ID：ART-<run短签>-<随机8位>。 */
